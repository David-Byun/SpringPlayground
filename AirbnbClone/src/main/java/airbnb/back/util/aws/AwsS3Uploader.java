...
import static airbnb.back.util.BaseResponseStatus.POST_IMAGE_CONVERT_ERROR;
import static airbnb.back.util.BaseResponseStatus.POST_IMAGE_INVALID_EXTENSION;
    ...
    public String upload(MultipartFile multipartFile, String dirName) {
        ...
        try {
            if (!multipartFile.isEmpty()) {
                ...
                //originFileName 변수에서 마지막 점(.) 다음의 문자열부터 끝까지를 추출하여 ext 변수에 할당합니다. 이렇게 함으로써 파일 이름의 확장자를 추출합니다.
